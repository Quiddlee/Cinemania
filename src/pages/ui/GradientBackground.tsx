  ...
  render() {
    return (
      <>
        ...
        <div className="absolute right-52 top-0 h-1/3 w-1/2 rounded-full bg-pink-300" />
        <div className="absolute left-96 top-0 h-1/4 w-1/3 rounded-full bg-violet-400 saturate-200" />
        <div className="absolute left-44 top-2/4 h-1/4 w-1/5 rounded-full bg-blue-400 saturate-200" />
