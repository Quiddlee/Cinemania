...
class NotFound extends Component {
  render() {
    return (
      <article className="mx-auto w-fit animate-fade-in rounded-[2rem] border-l border-t border-white/20 bg-white/10 px-6 py-10 text-center text-gray-400 backdrop-saturate-150">
